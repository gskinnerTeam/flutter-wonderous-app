...
class _SearchInput extends StatelessWidget {
  ...
  Widget _buildSuggestionTitle(BuildContext context) {
    return Container(
      ...
      child: CenterLeft(
        child: Text(
          localizationsLogic.instance.searchInputTitleSuggestions.toUpperCase(),
        ...
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: localizationsLogic.instance.searchInputHintSearch,
            ),
          ),
        ),
          ...
          builder: (_, value, __) => Visibility(
            ...
            child: Padding(
              ...
              child: CircleIconBtn(
                ...
                icon: Icons.clear,
                semanticLabel: localizationsLogic.instance.searchInputSemanticClear,
