...
// Search suggestions (66)
List<String> _searchSuggestions = const ['stamp', 'canaanite', 'figure', 'membranophone', 'seal', 'copper', 'molded', 'brass', 'dagger', 'alloy', 'silver', 'slip', 'animal', 'stone', 'opaque', 'sculpture', 'earthenware', 'incised', 'ink', 'jambiya', 'paper', 'ceramics', 'jasper', 'metal', 'unguentarium', 'ceramic', 'stonepaste', 'leather', 'green', 'folio', 'glazed', 'sherd', 'vessel', 'white', 'chordophone', 'fragment', 'book', 'lute', 'decoration', 'headed', 'female', 'codices', 'illustrated', 'scaraboid', 'drum', 'shahnama', 'jewelry', 'bronze', 'steatite', 'porcelain', 'wood', 'cultic', 'kings', 'painted', 'gold', 'watercolor', 'quartz', 'scarab', 'steel', 'manuscript', 'daggers', 'splash', 'head', 'sheath', 'bowl', 'scene', ];
...
List<SearchData> _searchData = const [
  ...
  SearchData(1600, 451725, '"The Concourse of the Birds", Folio 11r from a Mantiq al-tair (Language of the Birds)', 'folio from an illustrated manuscript|ink, opaque watercolor, gold, and silver on paper|codices', 'is/mobile-large/DP234083.jpg', 0.67),
  ...
  SearchData(1882, 73632, 'Mirror of National Costumes of All Nations  (Bankoku ishō kagami)', 'print|triptych of woodblock prints; ink and color on paper|prints', 'as/mobile-large/DP148176.jpg', 1.89),
